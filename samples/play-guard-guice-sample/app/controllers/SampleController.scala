...
/**
  ...
  */
@Singleton
class SampleController @Inject()(components: ControllerComponents)(implicit system: ActorSystem, conf: Configuration, ec: ExecutionContext) extends AbstractController(components) {
